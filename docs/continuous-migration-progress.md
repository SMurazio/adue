...
| 2 | Continuous collision (port `ContinuousCollision`; AABBs from blocked tiles) | **PLANNING** | depends 1 — resolver proven in spike; new part = derive AABBs from the blocked-tile grid + spatial query |
