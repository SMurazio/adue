...
-- Adds float (REAL) pos_x/pos_y columns ALONGSIDE the existing integer tile_x/tile_y (additive + reversible —
...
alter table characters add column pos_x real not null default 8;
alter table characters add column pos_y real not null default 8;
